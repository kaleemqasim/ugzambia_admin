<template>
    ...
    padding: 5px 10px;
    gap: 5px;
"><img src="https://sv.ugzambia.net/uploads/companies/company_1k2uwsqg0ncgrp9qqsfa.png" style="width: 80px;height: 55px;/* padding: 5px 0px 20px 30px; */margin-left: 10px;margin-right: 0px;"><!---->
<p style="color:white;font-size:20px;margin: 0;">UG Systems</p>
</div>
            <CloseOutlined
                v-if="innerWidth <= 991"
                :style="{
